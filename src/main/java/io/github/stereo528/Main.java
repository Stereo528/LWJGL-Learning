...
public class Main {
    ...
    private void init() {
        ...
        try {
            this.glslShader = new GLSLShader("/noise.vsh", "/noise.fsh");
        } catch (Exception e) {
    ...
    private void loop() {
        ...
        // Set the clear color
        glClearColor(127f/255f, 0.0f, 127f/255f, 0.0f);

        //glColor4f(127f/255f, 1.0f, 127f/255f, 1.0f);
        ...
        while ( !glfwWindowShouldClose(window) ) {
            ...
            this.glslShader.use(width, height, mouseX, mouseY, (System.currentTimeMillis() - startTime) / 1000f);
